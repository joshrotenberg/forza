...
pub struct AgentConfig {
    ...
    /// Context files to prepend to every stage prompt.
    ///
    /// These are read and prepended before skill files. Intended for
    /// language-specific or project-specific guidance generated by `forza init`.
    #[serde(default)]
